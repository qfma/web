...
## [O'Bleness et al.](http://g3journal.org/content/2/9/977) comments

The good:

- They seem to have a very good understanding of the NBPF gene architecture
- Using HMMER to confirm presence of DUF1120 domains

The bad:

- Versions of Ensembl and UCSC used unclear, only assembly given
- BLAT using human sequences may produce a phylogenetic bias in DUF1120 counts
- It seems they use total genomic counts, not feature counts. Totally unclear if the majority of those DUF1120 domains is translated?
- The total number of DUF1120 domains in a species is not equal to the number of DUF1120 domains in those genes with a CM promoter, except for humans.
- Pseudogenes are counted?

The ugly:

- No. of triplet domains in Table 2 is sometimes not divisible by 3?
- Assemblies change and the q21 region is unstable. Genes come and go like customers in a fast food restaurant. The quality of the assembly is probably also comparable to the food quality.
